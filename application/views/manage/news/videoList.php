...
<script type="text/javascript">
    $(function() {
        var videoList=new VideoList("<?php echo $menuid?>");

        $("#search<?php echo $menuid?>").click(function(){videoList.reloadList()});
...
<div id="videoListWin<?php echo $menuid?>" class="easyui-dialog">
        <div class="division">
            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="shopping_setting">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="videoListTitle<?php echo $menuid?>" class="easyui-validatebox easyui_form_input" style="width:240px;" data-options="required:true">
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        ...
                        <div id="videoPath<?php echo $menuid?>"></div>
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="division">
            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="shopping_setting">
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <script  id="videoListContent<?php echo $menuid ?>" type="text/plain"> </script>
                        </div>
                    </td>
                </tr>
